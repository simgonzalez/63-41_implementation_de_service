...
public class JpaPersonManagerTest {
    ...
    @Test
    public void find_by_age_success() {
        Person person = new Person(EMAIL, NAME, AGE);
        pm.insert(person);
    ...
    public void insert_List_Person_best_effort() {
        ...
        assertTrue(
            inserted.containsAll(
                persons
                    .stream()
                    .filter(person -> !person.equals(fred2))
                    .toList()
            )
        );
    ...
    public void insertOneTransaction_fail() {
        List<Person> persons = List.of(
            new Person("toto@gmail.com", "toto", 10),
            new Person("toto@gmail.com", "toto", 12)
        );
    ...
    @Test
    public void insertOneTransaction_success()
        throws PersonAlreadyExistException {
        List<Person> persons = List.of(
            new Person("toto@gmail.com", "toto", 10),
            new Person("tata@gmail.com", "tata", 12)
        );
    ...
    public void insertBestEffortCsv_success() throws IOException {
        ...
        assertEquals(
            true,
            pm.findAll().containsAll(Csv.parse("persons.csv", Person.class))
        );
    }
    ...
    public void insertBestEffortCsv_fail() throws IOException {
        ...
        assertTrue(
            failed.containsAll(
                List.of(new Person("toto@gmail.com", "tata", 12))
            )
        );
        ...
        assertEquals(
            ...
            pm
                .findAll()
                .containsAll(
                    Csv.parse("personsFailed.csv", Person.class)
                        .stream()
                        .filter(person ->
                            !person.equals(
                                new Person("toto@gmail.com", "tata", 12)
                            )
                        )
                        .toList()
                )
